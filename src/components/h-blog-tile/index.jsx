...
import classes from "./h-blog-tile.module.scss"
import Img from "gatsby-image"

export default function HBlogTile(props) {
  ...
  return (
    <Box className='card-content' boxShadow={0}  m={1}>
      <article>
        <Link to={props.blog.fields.slug}>
          <Card className={classes.card}  height={200}>
            {featuredImg}
            <div>
              <CardContent>
